<template>
  <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    <div
      ...
      style="background: url('/images/blocks/content/content-4.png')"
    >
      <div class="grid">
    ...
    <div class="grid">
      ...
      <div class="col-12 lg:col lg:px-5">
        ...
        >
          <div class="flex flex-row">
            ...
            >
            <span
              class="text-900 surface-100 inline-flex font-semibold py-2 px-3 border-round"
              >Education</span
            >
          </div>
        ...
        <div class="line-height-3 text-xl text-900 mb-5">
          Metus aliquam eleifend mi in nulla posuere. In vitae turpis massa sed
          elementum tempegestas sed. Dui ut ornare lectus sit. Massa ultricies
          mi quis hendrerit.
        </div>
        <div class="line-height-3 text-lg text-900 mb-4">
          Nisi est sit amet facilisis. Ac odio tempor orci dapibus ultrices in
          iaculis nunc sed. Pellentesque pulvinar pellentesque habitamorbi
          tristique senectus. Nullam vehicula ipsum a arcu cursus vitae congue.
          Leo urna molestie at elementum eu facilisis. Fusce id velit ut tortor.
          Purus non enim praesent elementum facilisis leo vel fringilla esSemper
          risus in hendrerit gravida rutrum quisque non tellus orci. Neque
          convallis a cras semper. Vitae elementum curabitur vitae nunc sed.
          Ornare massa eget egestas purus viverra accumsan in. Leo integer
          malesuada nunc vrisus commodo viverra maecenas accumsan. Sit amet
          risus nullam eget. Egestas maecenas pharetra convallis posuere morbi
          leo urna molestie at.
        </div>
        <blockquote
          class="surface-50 line-height-3 text-xl text-800 mb-4 py-3 px-3 border-round mx-0"
        >
          “In short, GPU.js is a JavaScript acceleration library that can be
          used for general-purpose computations on GPUs using JavaScript.
          supports browsers, Node.js and TypeScript.”
        </blockquote>
        <div class="line-height-3 text-lg text-900 mb-4">
          Convallis tellus id interdum velit laoreet id donec ultrices. Lacus
          sed viverra tellus in hac habitasse platea dictumst. Ultricitristique
          nulla aliquet enim. Nunc scelerisque viverra mauris in aliquam sem
        ...
        <div class="text-center mb-5">
          <img
            src="/images/blocks/content/content-3.svg"
            alt="Image"
        ...
        <div class="text-3xl text-800 mb-4">
        ...
        <div class="line-height-3 text-lg text-900 mb-5">
          ...
          vestibulum sed arcu non. Mauris vitae ultricies leo integmalesuada
          nunc vel. Dolor sit amet consectetur adipiscing elit ut aliquam purus.
          Ac tincidunt vitae semper quis lectus nulla at volutpat. Enim lobortis
          scelerisque fermentum dui faucibus in ornare. In mollis nunc sed id
          sempeVitae ultricies leo integer malesuada nunc vel risus commodo.
        </div>
        <div
      ...
      <div class="col-12 lg:col-3 lg:border-left-1 surface-border">
        <div class="p-3">
          ...
          <div class="flex pb-4">
            <img
              src="/images/blocks/content/content-5.png"
              class="mr-3 h-5rem w-5rem"
            />
            <div class="flex flex-column align-items-start">
              <span class="text-lg text-900 font-medium mb-1">Post Title</span>
              <span class="text-600 font-medium mb-2"
                >Metus aliquam eleifend mi in nulla posuere.</span
              >
            </div>
          </div>
          <div class="flex pb-4">
            <img
              src="/images/blocks/content/content-6.png"
              class="mr-3 h-5rem w-5rem"
            />
            <div class="flex flex-column align-items-start">
              <span class="text-lg text-900 font-medium mb-1">Post Title</span>
          ...
          <div class="flex pb-4">
            <img
              src="/images/blocks/content/content-7.png"
              class="mr-3 h-5rem w-5rem"
            />
            <div class="flex flex-column align-items-start">
              <span class="text-lg text-900 font-medium mb-1">Post Title</span>
            ...
            <div
              ...
              style="
                background: linear-gradient(
                  ...
                  ('images/blocks/content/content-8.png');
              "
            >
              <span class="text-white font-medium mb-3">Post Title</span>
              <span class="text-white block line-height-3"
                >Metus aliquam eleifend mi innulla posuere.</span
              >
            </div>
            <div
              class="w-full h-full p-5 border-round"
              style="
                background: linear-gradient(
                  ...
                  ('images/blocks/content/content-9.png');
              "
            >
              <span class="text-white font-medium mb-3">Post Title</span>
              <span class="text-white block line-height-3"
            ...
            <div
              ...
              style="
                background: linear-gradient(
                  ...
                  ('images/blocks/content/content-10.png');
              "
            >
              <span class="text-white font-medium mb-3">Post Title</span>
              <span class="text-white block line-height-3"
